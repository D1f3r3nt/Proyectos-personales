<html>
	...
	<form method="POST" action="make.php">
		...
		<center>
			<div class="imagen">
				<a href="index.php">
				<img src="imagenes/icono.png" width="100" height="100">
				</a>
			</div>
		<table border="0">
			<tr>
				<td>
					<center>
					<font size=8>Crear tabla</font>
					<br><br>
					<textarea name="msg" placeholder="Tarea">
					</textarea>
					<br><br>
					Fecha limite<br>
					<input type="date" name="fecha" placeholder="Fecha limite (dd/mm/yy)">
					<br><br>
