...
public class Loss extends Fragment {
    ...
    View vista;
    String[] precio_operacion, precio_inicial, precio_final, fecha, description;
    ...
    public static Loss newInstance(String param1, String param2) {
        Loss fragment = new Loss();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vista = inflater.inflate(R.layout.fragment_loss, container, false);
        ...
        LinearLayout ly = (LinearLayout) vista.findViewById(R.id.layaoutLoss);
        if(lineas > 0){
            if(lineas > 20)
                lineas = 20;
            ...
            TextView texto = new TextView(getActivity());
            texto.setText("No hay ninguna perdida hasta el momento");
